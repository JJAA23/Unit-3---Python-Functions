...
def calculate_engagement(likes, shares, comments):
    '''y. Calculate the total media engagement
    This functionm takes the number of likes, sgharea and xomments on a a post return the total engagement
    int = the total engagemenr, calculated as the sum of the bumbers
    '''
